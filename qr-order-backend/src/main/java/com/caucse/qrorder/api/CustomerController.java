...
public class CustomerController {
    ...
    ApiEnvelope<Map<String, Object>> resolve(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
                    content = @Content(schema = @Schema(implementation = OpenApiRequests.TableCredentials.class)))
    ...
    ApiEnvelope<Map<String, Object>> menu(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
                    content = @Content(schema = @Schema(implementation = OpenApiRequests.TableCredentials.class)))
            @RequestBody Map<String, Object> body) {
    ...
    ApiEnvelope<Map<String, Object>> createOrder(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
                    content = @Content(schema = @Schema(implementation = OpenApiRequests.CustomerOrderCreate.class)))
            @RequestBody Map<String, Object> body) {
    ...
    ApiEnvelope<Map<String, Object>> getOrder(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
                    content = @Content(schema = @Schema(implementation = OpenApiRequests.CustomerOrderGet.class)))
            @RequestBody Map<String, Object> body) {
    ...
    ApiEnvelope<Map<String, Object>> listOrders(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
                    content = @Content(schema = @Schema(implementation = OpenApiRequests.TableCredentials.class)))
            @RequestBody Map<String, Object> body) {
    ...
    ApiEnvelope<Map<String, Object>> createCall(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
                    content = @Content(schema = @Schema(implementation = OpenApiRequests.CustomerCallCreate.class)))
            @RequestBody Map<String, Object> body) {
    ...
    ApiEnvelope<Void> cancelCall(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
                    content = @Content(schema = @Schema(implementation = OpenApiRequests.CustomerCallCancel.class)))
            @RequestBody Map<String, Object> body) {
