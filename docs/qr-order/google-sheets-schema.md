...
> 정책 변경(2026-09-14): 아래의 “청구만 합쳐진다”는 과거 Sheets 계약 설명이다.
> 현행 정책은 합석 그룹의 주문내역도 공유한다. 주문의 원래 세션 귀속은 유지하며,
> 조회 범위와 분리 후 동작은 [스태프 POS 정책 §3.7](./staff-pos-design.md#37-a05--a06--합석-테이블-주문내역-공유)을 따른다.
